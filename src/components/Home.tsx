  ...
  return (
    <div className="parallax">
      <motion.div className="scroller" style={{ x }}>
        <span className="md:text-6xl sm:text-5xl text-4xl  ">{children} </span>
        <span className="md:text-6xl sm:text-5xl text-4xl  ">{children} </span>
        <span className="md:text-6xl sm:text-5xl text-4xl  ">{children} </span>
        <span className="md:text-6xl sm:text-5xl text-4xl  "> {children} </span>
      </motion.div>
...
<svg height="0" width="0" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="flex flex-col">
    ...
    <CountUp target={200} duration={2}/>
    <span className="text-xs xl:text-base text-black/60 text-nowrap">
      International Brands
    </span>
  </div>
  {/* Vertical Divider */}
  <div className="hidden sm:block ml-6 md:ml-0 h-12 md:h-full w-px bg-black/10"></div>
  <div className="flex flex-col ml-6 md:ml-0">
    {/* <span className="font-bold text-2xl md:text-xl lg:text-3xl xl:text-[40px] xl:mb-2">
      2000+
    </span> */}
    <CountUp target={2000} duration={2}/>
    <span className="text-xs xl:text-base text-black/60 text-nowrap">
  ...
  <div className="flex flex-col w-full text-center sm:w-auto sm:text-left mt-3 sm:mt-0 sm:ml-6 md:ml-0">
    {/* <span className="font-bold text-2xl md:text-xl lg:text-3xl xl:text-[40px] xl:mb-2">
     ...
     <CountUp target={3000} duration={2}/>
    <span className="text-xs xl:text-base text-black/60 text-nowrap">
      Happy Customers
    </span>
  </div>
        ...
        <div className="">
  <motion.img 
    src="https://cdni.iconscout.com/illustration/premium/thumb/female-ui-designer-illustration-download-in-svg-png-gif-file-formats--ux-design-user-interface-designing-uiux-pack-people-illustrations-5699694.png?f=webp" 
    className="w-auto h-auto lg:w-[650px] lg:h-[450px]"
    animate={{ y: [-20, 20] }} // moves from -20px to 20px
    transition={{ 
      duration: 3, 
      repeat: Infinity, 
      repeatType: "mirror", 
  ...
  />
     ...
     <section className="py-4">
      <ParallaxText baseVelocity={-5} >REACT JS DEVELOPER</ParallaxText>
      <ParallaxText baseVelocity={5} >WEBSITE DESIGNER</ParallaxText>
    </section>
  </div>
